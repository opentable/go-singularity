...
func (self *ExecutorID) MarshalJSON() ([]byte, error) {
...
func (self *ExecutorID) FieldsPresent() []string {
	return presenceFromMap(self.present)
}

func (self *ExecutorID) SetField(name string, value interface{}) error {
	if self.present == nil {
		self.present = make(map[string]bool)
	}
	switch name {
	default:
		return fmt.Errorf("No such field %s on ExecutorID", name)
	...
	case "defaultInstanceForType", "DefaultInstanceForType":
		...
		if ok {
			...
			return fmt.Errorf("Field defaultInstanceForType/DefaultInstanceForType: value %v couldn't be cast to type *ExecutorID", value)
		}
...
func (self *ExecutorID) GetField(name string) (interface{}, error) {
	switch name {
	default:
		return nil, fmt.Errorf("No such field %s on ExecutorID", name)
...
func (self *ExecutorID) ClearField(name string) error {
	if self.present == nil {
		self.present = make(map[string]bool)
	}
	switch name {
...
func (self *ExecutorID) LoadMap(from map[string]interface{}) error {
